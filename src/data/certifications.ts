...
export const CERTIFICATIONS: Record<string, Certification> = {
  'clf-c02': {
    ...
    passingScore: 700,
    domains: [
      { id: 1, name: 'Cloud Concepts', questionCount: 196, examProportion: 0.24 },
      { id: 2, name: 'Security & Compliance', questionCount: 220, examProportion: 0.30 },
      { id: 3, name: 'Cloud Technology & Services', questionCount: 408, examProportion: 0.34 },
      { id: 4, name: 'Billing, Pricing & Support', questionCount: 230, examProportion: 0.12 },
    ],
    status: 'active',
  },
  'saa-c03': {
